...
class AutoConvert extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($files as $file) {
            ...
            elseif (preg_match('/^('.$programId.'.*)\.vb/', $file->getFilename(), $matchesMainFilename)) {
                ...
                File::replaceInFile('yyyy年mm月dd日', 'yyyy年MM月dd日', $file->getPathname());
                ...
                $this->removeLineByKeySearch(preg_quote('lblPaperSize.Text = "Ａ４：縦"', '/'), $file->getPathname(), true);
                ...
                $this->removeLineByKeySearch(preg_quote("' 履歴", '/'), $file->getPathname(), true);
    ...
    protected function removeLineByKeySearch($keySearch, $path, $isRegex, $toString = '') {
        ...
        $exceptText = ['UPGRADE\_', preg_quote("' 履歴", '/')];
