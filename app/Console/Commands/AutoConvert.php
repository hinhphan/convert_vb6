    ...
    public function handle()
    {
        ...
        foreach ($files as $file) {
            ...
            if (preg_match('/(.*)\.Designer\.vb/', $file->getFilename(), $matchesMainFilename)) {
                ...
                File::replaceInFile('̧��', '�t�@�C��', $file->getPathname());
